    ...
    <section className="section-shell mt-8">
      <div className="glass-card overflow-hidden p-6 sm:p-8">
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <p className="soft-label">Matching Programs</p>
            <h3 className="mt-2 text-2xl font-semibold tracking-[-0.03em] text-slate-950">Checking the best-fit options</h3>
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Looking at subject fit, budget, format, location, and academic background.
            </p>
            <div className="mt-6 space-y-3">
              {["Filtering by grade and format", "Scoring the strongest subject matches", "Picking the few options worth showing"].map((item, index) => (
